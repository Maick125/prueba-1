...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="U4_Act12_Miguel_Castellanos.css">
    </head>
    <body>
            ...
            <table style="text-align: left; margin-left: auto; margin-right: auto;" border="1" cellpadding="1" >
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input class="inp" name="a" required="required" step="0.000001" type="number" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="inp" name="b" required="required" step="0.000001" type="number" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="inp" name="c" required="required" step="0.000001" type="number" />
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="2" rowspan="1">
                            <input id="bttn" value="Procesar" type="submit" />
                        </td>
                    </tr>
                </tbody>
            </table>
...
if ($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    else
    {
        $x1=0;
        $x2=0;
        echo 'No es una ecuaci&oacute;n cuadr&aacute;tica<br>';
    }
